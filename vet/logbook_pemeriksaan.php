...
<head>
	...
	<title>Logbook Pemeriksaan </title>
...
<body>
	...
	<center class="my-5 pt-5">
		<div style="width:90%; background-color:#063970;" class="py-4 px-2">
			<form method="GET" action="logbook_pemeriksaan.php" style="width: 100%;" class="row">
				<div style="color:white; text-align:left;" class="col-4">
					<h3>LOGBOOK PEMERIKSAAN</h3>
				</div>
				<div class="col-4">
				...
				<div class="col-3">
					<select class="form-select" name="by">
						...
						<option value='1'>ID Pemeriksaan</option>
		...
		<?php
			...
			if($by=='0')
				$sqlSearch="SELECT * FROM data_pemeriksaan";
			elseif($by=='1')
				$sqlSearch="SELECT * FROM data_pemeriksaan WHERE id_pemeriksaan='$search'";
			elseif($by=='2')
				$sqlSearch="SELECT * FROM data_pemeriksaan WHERE id_hewan='$search'";
		...
		<div style="width:90%;" class="px-2 mt-5">
			<table class="table table-bordered" style="text-align:center;">
				...
				<tbody>
					...
					<tr>
						<td><a href="data_pemeriksaan.php?id_hewan=<?=$data1['id_hewan'];?>&id_pemeriksaan=<?=$data1['id_pemeriksaan'];?>&message=lihat"><?= $data1['id_pemeriksaan'];?></a></td>
